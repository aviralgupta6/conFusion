...
export class ContactComponent implements OnInit {
    ...
    onSubmit() {
        ...
        // calls submit feedback, displays error message for 5 seconds POST is unsuccessful
        this.feedbackservice
            .submitFeedback(this.feedback)
            .subscribe(feedback => {
                this.processingFeedback = false
                this.formpost = feedback
                setTimeout(() => this.formpost = null, 5000)
            }, errmess => {
                this.feedbackErrMess = <any>errmess
                setTimeout(() => this.feedbackErrMess = null, 5000)
            })
